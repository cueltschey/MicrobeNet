...
driver = create_chrome_driver("http://protist.i.hosei.ac.jp/PDB/Images/Protista/SarcodiaE.html")
...
for link in links[86:]:
    driver = None
    print("Visiting: ", link)
    driver = create_chrome_driver(f"http://protist.i.hosei.ac.jp/PDB/Images/Sarcodina/{link}/index.html")
    get_images(link)
    driver.quit()
