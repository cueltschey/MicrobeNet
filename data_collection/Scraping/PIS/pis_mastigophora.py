...
driver = create_chrome_driver("http://protist.i.hosei.ac.jp/PDB/Images/Protista/MastigophoraE.html")
...
for link in links[51:]:
    driver = None
    print("Visiting: ", link)
    driver = create_chrome_driver(f"http://protist.i.hosei.ac.jp/PDB/Images/Mastigophora/{link}/index.html")
    get_images(link)
    driver.quit()
