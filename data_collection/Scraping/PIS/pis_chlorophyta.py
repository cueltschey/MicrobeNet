...
driver = create_chrome_driver("http://protist.i.hosei.ac.jp/PDB/Images/Protista/ChlorophytaE.html")
...
for link in links:
    driver = None
    print("Visiting: ", link)
    driver = create_chrome_driver(f"http://protist.i.hosei.ac.jp/PDB/Images/Chlorophyta/{link}/index.html")
    get_images(link)
    driver.quit()
